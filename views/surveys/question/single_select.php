<div class="ques_container border mb-4 rounded p-3 single_select" data-key="<?= isset($key) && $key != '' && $key >= 0 ? $key : 0 ?>">
	<b>[Single Select Question]</b>
	<div class="title mt-2">
		<label>Question Title</label>
		<input type="hidden" class="form-control" name="question[<?= isset($key) && $key != '' && $key >= 0 ? $key : '{{key}}' ?>][type]" value="single_select" placeholder="Title">
